...
export function SheetTableHead() {
  return (
    <TableHeader className="text-sm">
      <TableRow className="bg-gray-100 hover:bg-bg-gray-100">
        <TableHead className="text-center font-semibold border border-black py-1 px-2 w-18">
          Date
        </TableHead>
        ...
        <TableHead className="text-center font-semibold border border-black py-1 px-2 w-10">
          Signature
        </TableHead>
      </TableRow>
    </TableHeader>
