...
type AttendanceDefaultsDialogProps = {
  open: boolean;
...
export function AttendanceDefaultsDialog({
  open,
  setOpen,
  defaults,
  isSubmitting,
  onSubmit,
}: AttendanceDefaultsDialogProps) {
  ...
  }, [defaults.destination, defaults.remarks, open]);
  ...
  return (
    <Custom open={open} onOpenChange={setOpen}>
      <CustomContent
        className="max-w-full p-4 md:max-w-[425px] md:p-6"
        side="bottom"
      >
