...
export function SignatoriesPreview({ signatories }: SignatoriesPreviewProps) {
  ...
  return (
    <footer className="mx-auto flex max-w-4xl justify-between gap-4 print:max-w-175">
      ...
      {signature.success &&
        ...
        signatory.name && (
          <Image
            ...
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-auto"
            width={180}
            height={108}
          />
        )}
