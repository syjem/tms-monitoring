...
export function NetworkStatusBanner() {
  ...
  const message = isOffline
    ...
    : 'Your connection looks unstable. Requests might fail intermittently.';

  return (
    <div className="sticky top-0 z-50 w-full border-b border-amber-300 bg-amber-50 text-amber-900">
