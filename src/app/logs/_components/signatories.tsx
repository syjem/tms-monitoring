...
export const Signatories = ({ isEditable, signatories }: SignatoriesProps) => {
  ...
  return (
    <React.Fragment>
      ...
      <footer className="flex gap-4 justify-between mx-auto max-w-4xl print:max-w-175">
        {firstSignatory.name ? (
          <div
            ...
            {signature.success &&
              ...
              firstSignatory.includeSignature && (
                <Image
                  ...
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-45 h-30"
                  width={180}
                  height={120}
                />
              )}
